...
namespace CCA__1
{
    class Program
    {
        ...
        {
            Console.WriteLine("This is CCA - 1               ");
            Console.WriteLine("Language: C#(.Net Framework)  ");
            Console.WriteLine("");
            Console.WriteLine(" Questions are :-             ");
            Console.WriteLine("");
            Console.WriteLine(" 1. Remove Charcter.          ");
            Console.WriteLine(" 2. Exchange Character.       ");
            Console.WriteLine(" 3. Check Largest NUmber.     ");
